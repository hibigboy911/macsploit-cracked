...
main() {
    ...
    then
        ...
        local resp=$(curl -s "freekeyyippee")
        echo -e "Done.\n$resp"
    ...
    curl "https://github.com/DreamHackqwerty/macsploit-cracked/blob/bcded9cb41c49276c4c0e7311995e2282b4ce873/MacSploit.zip" -o "./MacSploit.zip"
    ...
    echo -e "Done."
    echo -e "Install Complete! Developed by Nexus42! Cracked By Casmic :3"
    exit
}
